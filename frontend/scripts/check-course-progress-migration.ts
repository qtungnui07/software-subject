...
const defaultProgress = createDefaultCourseProgress();
...
assert(
  getCurrentNodeIdForSection(defaultProgress, "english-section-1") === "lesson-1",
  "New users must start at lesson-1."
);
...
const projectedLegacy = projectCourseProgressToChapterOne(migrated);
...
const unlocked = unlockCourseSection(migrated, "english-section-2");
...
console.log(
  "Course progress migration check passed: default unlock, legacy preservation, reverse projection and Section 2 unlock are valid."
);
