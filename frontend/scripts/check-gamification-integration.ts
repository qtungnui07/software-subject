...
const allPlayableIds = englishCourse.sections.flatMap((section) =>
...
const stats = getLearningProfileStats(profileProgress);
...
console.log(
  "Gamification integration check passed: first completions, partial XP recovery, duplicate guards, and Section 1-3 profile stats are valid.",
);
