...
export const ProgressOverview = ({
  ...
  return (
    <section
      className={cn(
        "overflow-hidden rounded-[24px] border-2 border-sky-100 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md",
        className
      )}
    >
      ...
      <div className="mt-5 rounded-[22px] border-2 border-sky-100 bg-sky-50/70 p-4">
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        ...
        <div className="col-span-2 rounded-2xl border-2 border-slate-100 bg-white p-3">
      ...
      {isCompleted ? (
        <p className="mt-4 rounded-2xl bg-emerald-50 px-4 py-3 text-sm font-bold text-emerald-600">
          Tuyệt vời! Bạn đã hoàn thành khóa học này.
        </p>
      ) : (
        <p className="mt-4 rounded-2xl bg-sky-50 px-4 py-3 text-sm font-bold text-sky-600">
