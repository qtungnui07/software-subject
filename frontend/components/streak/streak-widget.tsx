    ...
    return (
        <Link href="/learn" aria-label={ariaLabel} title={ariaLabel}>
            <Button
                variant="ghost"
                className={
                    `gap-x-2 border-2 border-orange-100 bg-orange-50/80 px-3 text-orange-600 hover:bg-orange-100 hover:text-orange-700 ${className ?? ""}`
                }
            >
                ...
                {isFallback ? (
                    <span className="hidden rounded-full bg-white/70 px-1.5 py-0.5 text-[10px] font-black uppercase text-orange-400 2xl:inline">
                        Demo
                    </span>
                ) : null}
            </Button>
