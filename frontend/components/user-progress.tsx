...
export const UserProgress = ({
  ...
  return (
    <div className="flex w-full items-center justify-between gap-2">
      <Link
        href="/courses"
        className="group flex size-14 shrink-0 items-center justify-center rounded-[18px] border-2 border-transparent bg-white dark:bg-[#141f23] transition hover:border-[#d6ecfb] hover:bg-[#f4fbff] dark:hover:border-[#202f36] dark:hover:bg-[#1f2d33]/50"
