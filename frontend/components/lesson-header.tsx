...
export const LessonHeader = ({ title, progress, hearts, onExitClick }: Props) => {
  return (
    <header className="sticky top-0 z-50 border-b-2 border-slate-200 bg-white px-4 py-4 md:px-6">
      <div className="mx-auto flex max-w-[840px] items-center justify-between gap-4 md:gap-6">
        {/* Nút thoát */}
        <button
          type="button"
          onClick={onExitClick}
          className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-slate-50 text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 active:scale-95 border border-slate-200"
        ...
        <div className="flex flex-1 flex-col items-center">
          ...
          <div className="relative h-4 w-full overflow-hidden rounded-full bg-slate-100 border border-slate-200 shadow-inner">
            <div
        ...
        {/* Số tim */}
        <div className="flex shrink-0 items-center gap-1.5 rounded-2xl border border-rose-100 bg-rose-50/50 px-3 py-1.5 text-rose-500 shadow-sm">
